...
GATEWAY_ENGINE_MODEL_ABSENCE_RETIRE_DAYS = config.MODEL_ABSENCE_RETIRE_DAYS
GATEWAY_ENGINE_MODEL_ABSENCE_ALERT_PENDING_DAYS = config.MODEL_ABSENCE_ALERT_PENDING_DAYS
...
def _build_model_reconciliation_service() -> ModelReconciliationService:
    ...
    return ModelReconciliationService(
        ...
        timeout_sec=GATEWAY_ENGINE_MODEL_RECONCILIATION_TIMEOUT_SEC,
        absence_retire_days=GATEWAY_ENGINE_MODEL_ABSENCE_RETIRE_DAYS,
    )
...
TOKEN_CACHE_INPUT = proxy_routes.TOKEN_CACHE_INPUT
TOKEN_CACHE_OUTPUT = proxy_routes.TOKEN_CACHE_OUTPUT
TOKEN_CACHE_CANONICAL_INPUT = proxy_routes.TOKEN_CACHE_CANONICAL_INPUT
TOKEN_CACHE_CANONICAL_OUTPUT = proxy_routes.TOKEN_CACHE_CANONICAL_OUTPUT
...
_record_cached_token_usage = proxy_routes._record_cached_token_usage
