...
class Config:
    ...
    POLICY_ENGINE_STRICT = _env_bool(
        ("POLICY_ENGINE_STRICT", "GATEWAY_ENGINE_POLICY_ENGINE_STRICT", "POLICY_ENGINE_ENFORCE"),
        False,
    )
    MCP_VISIBILITY_ENABLED = _env_bool(
        ("MCP_VISIBILITY_ENABLED", "GATEWAY_ENGINE_MCP_VISIBILITY_ENABLED"),
        False,
    )
    LOCAL_MCP_TOOL_HOST_ENABLED = _env_bool(
        ("LOCAL_MCP_TOOL_HOST_ENABLED", "GATEWAY_ENGINE_LOCAL_MCP_TOOL_HOST_ENABLED"),
        False,
    )
    CONFIG_GENERATION_API_ENABLED = _env_bool(
