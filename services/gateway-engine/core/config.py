...
class Config:
    ...
    TEAM_BUDGET_SNAPSHOT_ENABLED = os.environ.get("GATEWAY_ENGINE_TEAM_BUDGET_SNAPSHOT_ENABLED", "true").lower() == "true"
    TEAM_BUDGET_CACHE_TTL_SEC = int(os.environ.get("GATEWAY_ENGINE_TEAM_BUDGET_CACHE_TTL_SEC", "60"))
    LITELLM_ADMIN_URL = os.environ.get("GATEWAY_ENGINE_LITELLM_ADMIN_URL") or os.environ.get("LITELLM_ADMIN_URL", "http://litellm:4000")
