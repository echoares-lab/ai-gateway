...
Repo-specific operating details for `docs/process/REPO_IMPROVEMENT_WORKFLOW.md`.
Gate definitions: `docs/process/TESTING_AND_PROMOTION_POLICY.md`. Testing guide: `docs/TESTING.md`. CI runner: `docs/CI_SELF_HOSTED.md`.
...
issues or explicit stack order — see `docs/process/REPO_IMPROVEMENT_WORKFLOW.md` §9.
