...
See also: `docs/process/TESTING_AND_PROMOTION_POLICY.md`, `docs/process/REPO_IMPROVEMENT_APPENDIX.md`.
...
Issues touching the same hotspot (e.g. `main.py`) must serialize via `Depends on:` or this stack-then-rebase pattern.
